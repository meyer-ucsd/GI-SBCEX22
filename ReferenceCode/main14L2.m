...
scenario.isKnown = true(numParameters,1);
scenario.isKnown(2:numParameters) = false;
...
scenario.prior.topSpeed1 = [1350;1550];
scenario.prior.density1 = [1.00;2.50];
scenario.prior.attenuation1 = [0;0.3];
scenario.prior.bottomSpeed1 = [1350;1550];
scenario.prior.thickness1 = [5;15];

scenario.prior.topSpeed2 = [1350;1550];
scenario.prior.density2 = [1.00;2.50];
scenario.prior.attenuation2 = [0;0.3];
